...
/**
 * @Note: this file product by tools, you should only change the comment about ATTRIB_LIST, your
 * another change will be cover. @Author: ProtossGenius @Time: 2021-02-09 16:00:58
 */
public class AttributeAdapter extends SMAttribute {
  ...
  */
  ...
  /** 设置 最大蓝量. */
  public void setMaxMp(double _maxmp) {
    setAttribute(MaxMp, _maxmp);
  }
  /** 获得 最大蓝量. */
  public double getMaxMp() {
    return getAttribute(MaxMp);
  }
  /** 设置 速度. */
  public void setSpd(double _spd) {
    setAttribute(Spd, _spd);
  }
  /** 获得 速度. */
  ...
  /** 设置 敏捷（命中和闪避）. */
  public void setAgi(double _agi) {
    setAttribute(Agi, _agi);
  }
  /** 获得 敏捷（命中和闪避）. */
  ...
  /** 设置 金. */
  public void setMetal(double _metal) {
    setAttribute(Metal, _metal);
  }
  /** 获得 金. */
  ...
  /** 设置 木. */
  public void setWood(double _wood) {
    setAttribute(Wood, _wood);
  }
  /** 获得 木. */
  ...
  /** 设置 水. */
  public void setWater(double _water) {
    setAttribute(Water, _water);
  }
  /** 获得 水. */
  ...
  /** 设置 火. */
  public void setFire(double _fire) {
    setAttribute(Fire, _fire);
  }
  /** 获得 火. */
  ...
  /** 设置 土. */
  public void setEarth(double _earth) {
    setAttribute(Earth, _earth);
  }
  /** 获得 土. */
  ...
  /** 设置 雷. */
  public void setThunder(double _thunder) {
    setAttribute(Thunder, _thunder);
  }
  /** 获得 雷. */
  ...
  /** 设置 冰. */
  public void setIce(double _ice) {
    setAttribute(Ice, _ice);
  }
  /** 获得 冰. */
