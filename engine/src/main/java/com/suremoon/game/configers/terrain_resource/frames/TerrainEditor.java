...
public class TerrainEditor extends JFrame {
  ...
  JLabel /*choiceResTypeL,*/ // no-need, it config in res xml;
      ...
      passableOL,
      passableIL;
  JComboBox /*resTypeListCB,*/ preViewTypeCB, passableOCB, passableICB, buffListCB;
  JTextField resNameTF, extraPTF;
  JTable buffListT;
  DefaultTableModel buffListDTM = new DefaultTableModel();
  DefaultComboBoxModel /*resTypeListDCBM = new DefaultComboBoxModel(),*/ buffListDCBM =
  ...
  public void initAction() {
    ...
    preViewTypeCB.addActionListener(
        (ActionEvent e) -> {
          new Thread(
                  () -> {
                    PreviewShow();
    ...
    addBuffB.addActionListener(
        (ActionEvent e) -> {
          addBuff();
        });
    deleteChoiceB.addActionListener(
        (ActionEvent e) -> {
          deleteChoice();
        });
