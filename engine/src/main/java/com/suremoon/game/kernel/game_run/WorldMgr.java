...
public class WorldMgr implements WorldMgrItf {
            ...
            for (ConfigInf it : list){
                ...
                JarLoader.NewClass(line, (ins)->{
                    if (ins instanceof WorldMgrModItf){
                        ...
                        ErrorDeal.putError("In WorldManager.loadModCfg, class " + line + " not a WorldMgrModItf");
                    }
                });
            }
    ...
    public void run() {
        ...
        for (WorldMgrModItf mod : modItfs){
            System.out.println("[WorldManager] Loading Mod [" + mod.ModName() + "], Class Name is : <" + mod.getClass().getName() + ">  ........");
            mod.Do(this);
