...
public class TerrainIniter extends Initer {
  ...
  protected void do_init(ConfigInf ci) throws Exception {
    ...
    String sInterval =
        ci.getConfig("Interval") == null ? "70" : ci.getConfig("Interval").getValue();
    ...
    TerrainInformation ti =
        new TerrainInformation(
            adapter, buffs, walkable, isDecorate.toLowerCase().equals("true"), taCol, interval);
