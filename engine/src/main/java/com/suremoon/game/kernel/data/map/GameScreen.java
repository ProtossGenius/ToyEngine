...
public class GameScreen implements GameScreenItf {
    ...
    public void showMap(Graphics gp) {
        int stx = focusPoint.x / gameMap.getTerrainWidth(), sty = focusPoint.y / gameMap.getTerrainHeight(),
                cols = GameConfiger.DESIGN_SCREEN_WIDTH / gameMap.getTerrainWidth(), rows = GameConfiger.gc.DESIGN_SCREEN_HEIGHT / gameMap.getTerrainHeight();
    ...
    public Rectangle getScreenRect() {
        return new Rectangle(focusPoint.x, focusPoint.y, GameConfiger.DESIGN_SCREEN_WIDTH, GameConfiger.DESIGN_SCREEN_HEIGHT);
    }
