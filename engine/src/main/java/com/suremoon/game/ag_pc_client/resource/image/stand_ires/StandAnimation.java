...
public class StandAnimation {
  ...
  public StandAnimation(String confPath)
  ...
  public StandAnimation(ConfigInf ec)
      throws NotLeafException, NoSuchConfigException, SAXException, ParserConfigurationException,
    ...
    for (int i = 0; i < rcs.length; ++i) {
      String confId = rcs[i].getValue("ConfId"), cPath = rcs[i].getValue("ConfPath");
  ...
  // SAXException, NotLeafException, ParserConfigurationException, NoSuchConfigException,
  // IOException {
