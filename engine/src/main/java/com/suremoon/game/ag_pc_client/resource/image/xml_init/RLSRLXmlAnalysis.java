...
public class RLSRLXmlAnalysis extends ResXmlAnalysis {
  ...
  public void analysis(ConfigInf conf, Map<String, PicAreaArrayItf> res, String base_path)
    ...
    String sRows = conf.getConfig("Rows").getValue(),
        sCols = conf.getConfig("Cols").getValue(),
        sSize = conf.getConfig("Size").getValue(),
        sRow = conf.getConfig("Row").getValue(),
        sCol = conf.getConfig("Col").getValue();
