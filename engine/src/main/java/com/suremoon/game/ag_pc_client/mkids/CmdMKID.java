...
import com.suremoon.game.kernel.data.command_analysis.CmdCreator;
...
//                System.out.println("sa type is" + sa.sa_type);
        ...
        if ((cc = cmdAnalysis.getCmdCreator()) != null) {
             ...
             */
            CommandItf cmd = cc.productCommand(targetUnit, lastPoint).setAppendCmd(smkb.isKeyPressed(KeyEvent.VK_SHIFT));
