...
/**
 * 文件管理功能、进度条功能、打开文件功能、复选按钮、单选按钮 、 下拉菜单、列表菜单、表格演示等功能
 *
 * @author LzwGlory
 * @version 2014/2/18
 */
  ...
  class MenuTest extends JMenuBar { // 继承菜单Bar
    ...
    public MenuTest() {
      ...
      exitMenuItem.addActionListener(
          new ActionListener() { // 给退出菜单项添加一个退出时间
    ...
    public void initAboutDialog() { // 初始化dialog
      ...
      JLabel aboutLabel =
          new JLabel("<html><b><font size=5>" + "<center>Swing!" + "<br>", icon, JLabel.CENTER);
  ...
  class LeftPanel extends JPanel {
    ...
    public LeftPanel() {
      ...
      tree.addTreeSelectionListener(
          new TreeSelectionListener() { // 给每个节点添加监听事件
  ...
  class RightPanel extends JPanel { // 继承一个面板
    ...
    public RightPanel() {
      ...
      button.addActionListener(
          new ActionListener() { // 给这个文件添加一个事件
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              if (resule == file.APPROVE_OPTION) {
                ...
                JOptionPane.showConfirmDialog(
                    null, dir + "\\" + fileName, "选择的文件", JOptionPane.YES_OPTION); // 显示一个confirm的窗口
              }
            }
          });
      ...
      comboBox.addActionListener(
          new ActionListener() { // 添加一个多选框的事件选择哪个弹出哪个的值
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              JOptionPane.showMessageDialog(null, mes, "消息框", JOptionPane.YES_OPTION);
            }
          });
      ...
      this.setBorder(
          new EtchedBorder(EtchedBorder.LOWERED, Color.LIGHT_GRAY, Color.blue)); // 设置边框的样式
    }
  }
  ...
  class CenterPanel extends JPanel {
    ...
    public CenterPanel() {
      ...
      JSplitPane splitPane =
          new JSplitPane(
              JSplitPane.VERTICAL_SPLIT, textField, textPane); // 实例化一个文本分割面板把 文本编辑字段 和 文本编辑面板分割 开了
