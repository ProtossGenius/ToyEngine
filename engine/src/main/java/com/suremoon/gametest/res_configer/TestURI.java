...
public class TestURI {
    public static void main(String[] args) throws Exception {
        ...
        while(true){
            ...
            agsAdapter.show(jp.getGraphics(), "lumberjack with axe 96x bitmaps\\talking", new GRect(0, 0, 500, 500), new PointF(0, 1), System.currentTimeMillis() - start, 50, true, new Point(0, 0));
            jp.refresh();
            Thread.sleep(15);
        }
    }
