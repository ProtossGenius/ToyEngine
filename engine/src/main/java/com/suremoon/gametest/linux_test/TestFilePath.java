...
public class TestFilePath {
    public static void main(String[] args) throws ParserConfigurationException, NoSuchConfigException, SAXException, TransformerConfigurationException, IOException {
