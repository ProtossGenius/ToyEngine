...
public class RandomMoveAd implements CmdActionItf {
    ...
    public boolean actionDo(CommandItf cmd, WorldItf world, WorldMgrItf worldMgr) {
        ...
        //     cmd.remove();
        // }
        u.acceptCmd(CmdInfManager.CIM.productCommand(IDManager.getID("CmdWalk"), nowP.toPoint(), -1).setAppendCmd(true));
        u.acceptCmd(CmdInfManager.CIM.productCommand(IDManager.getID("CmdRandMove"), nowP.toPoint(), -1).setAppendCmd(true));
        return true;
    }
