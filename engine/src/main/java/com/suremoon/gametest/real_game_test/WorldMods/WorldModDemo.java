...
//        farmer.addCmd(CmdInfManager.CIM.productCommand(IDManager.getID("CmdAttack"), farmer, new Point(100, 100), null, gr.getGm()));
//        farmer.addCmd(CmdInfManager.CIM.productCommand(IDManager.getID("CmdWalk"), farmer, new Point(500, 500), null, gr.getGm()));
//        farmer.addCmd(CmdInfManager.CIM.productCommand(IDManager.getID("CmdWalk"), farmer, new Point(5000, 5000), null, gr.getGm()));
